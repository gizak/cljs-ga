...
*/
om_tools.dom.opt_key_case = (function opt_key_case(attr){if(cljs.core.truth_((function (){var or__3553__auto__ = (cljs.core.count.call(null,attr) < (5));if(or__3553__auto__)
...
*/
om_tools.dom.opt_key_alias = (function opt_key_alias(opt){var G__10785 = (((opt instanceof cljs.core.Keyword))?opt.fqn:null);switch (G__10785) {
case "for":
...
{return cljs.core.clj__GT_js.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__10789){var vec__10790 = p__10789;var k = cljs.core.nth.call(null,vec__10790,(0),null);var v = cljs.core.nth.call(null,vec__10790,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_tools.dom.format_opt_key.call(null,k),om_tools.dom.format_opt_val.call(null,v)], null);
}),opts)));
} else
{return opts;
}
...
om_tools.dom.element = (function element(ctor,opts,children){var vec__10792 = om_tools.dom.element_args.call(null,opts,children);var opts__$1 = cljs.core.nth.call(null,vec__10792,(0),null);var children__$1 = cljs.core.nth.call(null,vec__10792,(1),null);return cljs.core.apply.call(null,ctor,cljs.core.flatten.call(null,cljs.core.cons.call(null,opts__$1,children__$1)));
});
